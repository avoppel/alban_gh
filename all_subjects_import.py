...
this_raw_folder = '/home/shared/Weibull_PRF/raw/'
...
for which_subject in subject_initials:
	...
	if which_subject == 'DvE':
		...
		birthdate = datetime.date()					# look up, yyyymmdd
		...
		sessionID = 'Weibull_PRF' + presendSubject.initials
		sessionDate = datetime.date(2014, 07, 24)
		sj_session = 'DvE_240714'
		
		presentSession = BRTransSession.BRTransSession(sessionID, sessionDate, 
													   presentProject, presentSubject)
		...
		runWBPRFArray = [
			# 10 runs met de PRF taak, 1 run T2, 1 run T1.
			{
				...
				'rawDataFilePath': os.path.join(this_raw_folder, sj_session, 'mri',
				'DvE_1_WIP_pRF01_SENSE_4_1.nii.gz'),
				'rawBehaviorFile': [os.path.join(this_raw_folder, sj_session, 'gedrag',
												 'DvE_240714_run_01_cat_06_stim.txt'),
									os.path.join(this_raw_folder, sj_session, 'gedrag',
												 'DvE_240714_run_01_cat_06_no_stim.txt')],
				'physiologyFile': os.path.join(this_raw_folder, sj_session, 'hr',
				'DvE_1_pRF01.phy'),
				'eyeLinkFilePath': os.path.join(this_raw_folder, sj_session, 'eye',
				'DvE01.edf')				
			},
			{
				...
				'rawBehaviorFile': [os.path.join(this_raw_folder, sj_session, 'gedrag',
									...
									os.path.join(this_raw_folder, sj_session, 'gedrag', 												 'DvE_240714_run_02_cat_03_no_stim.txt')],
				'physiologyFile': os.path.join(this_raw_folder, sj_session, 'hr',
				'DvE_1_pRF02.phy'),
				'eyeLinkFilePath': os.path.join(this_raw_folder, sj_session, 'eye',
				'DvE02.edf')				
